...
- ![Spring%20Security](https://img.shields.io/badge/Spring%20Security-6DB33F.svg?logo=springsecurity&logoColor=white)
  ![OAuth2](https://img.shields.io/badge/OAuth2-6DB33F.svg?logo=springsecurity&logoColor=white)
  ![JWT](https://img.shields.io/badge/JWT-000000.svg?logo=jsonwebtokens&logoColor=white)
  ![Snowflake ID](https://img.shields.io/badge/Snowflake%20ID-29B5E8.svg?logo=snowflake&logoColor=white)
...
- ![k6](https://img.shields.io/badge/k6-7D64FF.svg?logo=k6&logoColor=white)
  ![Apache JMeter](https://img.shields.io/badge/Apache%20JMeter-D22128.svg?logo=apachejmeter&logoColor=white)
...
- ![Amazon AWS](https://img.shields.io/badge/AWS-232F3E.svg?logo=icloud&logoColor=white)
  ![AWS EC2](https://img.shields.io/badge/AWS%20EC2-FF9900.svg?logo=icloud&logoColor=white)
  ![AWS ELB](https://img.shields.io/badge/AWS%20ELB-FF9900.svg?logo=icloud&logoColor=white)
  ![AWS VPC](https://img.shields.io/badge/AWS%20VPC-FF9900.svg?logo=icloud&logoColor=white)
  ![AWS ECR](https://img.shields.io/badge/AWS%20ECR-FF9900.svg?logo=icloud&logoColor=white)
  ![AWS ECS](https://img.shields.io/badge/AWS%20ECS-FF9900.svg?logo=icloud&logoColor=white)
  ![AWS S3](https://img.shields.io/badge/AWS%20S3-569A31.svg?logo=icloud&logoColor=white)
  ![AWS RDS](https://img.shields.io/badge/AWS%20RDS-527FFF.svg?logo=icloud&logoColor=white)
  ![AWS DynamoDB](https://img.shields.io/badge/AWS%20DynamoDB-4053D6.svg?logo=icloud&logoColor=white)
  ![AWS IAM](https://img.shields.io/badge/AWS%20IAM-DD344C.svg?logo=icloud&logoColor=white)
  ![AWS Secrets%20Manager](https://img.shields.io/badge/AWS%20Secrets%20Manager-DD344C.svg?logo=icloud&logoColor=white)
  ![AWS CloudWatch](https://img.shields.io/badge/AWS%20CloudWatch-FF4F8B.svg?logo=icloud&logoColor=white)
  ![AWS X--Ray](https://img.shields.io/badge/AWS%20X--Ray-FF4F8B.svg?logo=icloud&logoColor=white)
  ![AWS CodeDeploy](https://img.shields.io/badge/AWS%20CodeDeploy-0073BB.svg?logo=icloud&logoColor=white)
  ![AWS CodeBuild](https://img.shields.io/badge/AWS%20CodeBuild-0073BB.svg?logo=icloud&logoColor=white)
  ![AWS CloudFront](https://img.shields.io/badge/AWS%20CloudFront-8C4FFF.svg?logo=icloud&logoColor=white)
  ![AWS Route%2053](https://img.shields.io/badge/AWS%20Route%2053-8C4FFF.svg?logo=icloud&logoColor=white)
  ![AWS Elastic%20IP](https://img.shields.io/badge/AWS%20Elastic%20IP-8C4FFF.svg?logo=icloud&logoColor=white)
  ![AWS SNS](https://img.shields.io/badge/AWS%20SNS-8C4FFF.svg?logo=icloud&logoColor=white)
  ![AWS SQS](https://img.shields.io/badge/AWS%20SQS-8C4FFF.svg?logo=icloud&logoColor=white)
...
- ![IntelliJ IDEA](https://img.shields.io/badge/IntelliJ%20IDEA-000000.svg?logo=intellijidea&logoColor=white)
  ...
  ![GitKraken](https://img.shields.io/badge/GitKraken-179287.svg?logo=gitkraken&logoColor=white)
  ![MySQL Workbench](https://img.shields.io/badge/MySQL%20Workbench-4479A1.svg?logo=mysql&logoColor=white)
  ...
  ![CMD](https://img.shields.io/badge/Command%20Line-000000.svg?logo=gnu-bash&logoColor=white)
...
- ![Discord](https://img.shields.io/badge/Discord-5865F2.svg?logo=discord&logoColor=white)
  ![Slack](https://img.shields.io/badge/Slack-4A154B.svg?logo=wechat&logoColor=white)
...
| 6     | 그림으로 이해하는 도커와 쿠버네티스                          | 길벗               | - 읽는 중 | 서평단 참여 |




### **🔍 Engineering Retrospectives & Problem Solving**

| Index | Title                                                        | Write At |
| ----- | ------------------------------------------------------------ | -------- |
| 1     | [수십 만 건 이상의 주문 데이터와 시스템 조회 성능 최적화](https://limdaeil.tistory.com/7) | 2025.11  |
| 2     | [커서 기반 페이징과 N+1을 설계 구조로 해결하기](https://limdaeil.tistory.com/18) | 2025.12  |
